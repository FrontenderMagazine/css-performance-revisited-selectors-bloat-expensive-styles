...
с целью повышения производительности в современных браузерах — бессмысленно;
 ...
 тратить время. Более того, у браузеров не обнаруживается единое мнение о том,
 ...
 производительности, чем любые селекторы, это второй момент, на который нужно
 обратить внимание. 3000 строчек лишнего кода на странице — не такое уж редкое
